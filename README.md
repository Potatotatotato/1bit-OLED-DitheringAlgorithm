...
2. 截取`显示器`画面并进行图像处理
3. 获取`摄像头`画面并进行图像处理
4. 将图像流保存至[ditheringVideo.bin](https://github.com/Potatotatotato/1bit-OLED-DitheringAlgorithm/blob/main/VisualStudio_Project/1bit-OLED-DitheringAlgorithm/ditheringVideo.bin)，该文件可以使用串口助手直接发送至单片机
